...
import com.hhplus.api.presentation.common.exception.UserNotFoundException;
...
public class LectureRegisController {
    ...
    public ApiResponse regist(@RequestBody RegistRequest request) {
        ...
        if (info == null){
            throw new UserNotFoundException(new ApiResponseHeader(400, "해당 유저를 찾을 수 없습니다."));
        }
    ...
    public ApiResponse selectableList(@RequestParam(name = "date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date,
